  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-sans tracking-wide uppercase",
  {
    variants: {
      variant: {
        ...
        // FORNO NERO custom variants
        hero: "bg-transparent border border-foreground text-foreground hover:bg-foreground hover:text-background tracking-[0.2em]",
        ember: "bg-ember text-accent-foreground hover:bg-ember-glow tracking-[0.15em] shadow-lg shadow-ember/20",
        subtle: "bg-transparent text-foreground hover:text-ember border-b border-transparent hover:border-ember tracking-[0.15em]",
      },
      size: {
